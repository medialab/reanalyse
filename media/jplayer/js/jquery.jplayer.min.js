...
//volumeBar:function(a){if(!this.status.muted&&this.css.jq.volumeBar){var b=this.css.jq.volumeBar.offset();a=a.pageX-b.left;b=this.css.jq.volumeBar.width();this.volume(a/b)}}
...
volumeBar: function(e) { // Handles clicks on the volumeBar 
	...
	//var v = x/w; 
	var y = this.css.jq.volumeBar.height() - e.pageY + offset.top;
	var h = this.css.jq.volumeBar.height(); 
	var v = y/h; 
	this.volume(v); 
	}
},

volumeBarValue:function(a){this.volumeBar(a)},_updateVolume:function(a){this.css.jq.volumeBarValue.length&&this.css.jq.volumeBarValue.height((1-a)*100+"%")},_volumeFix:function(a){var b=0.0010*Math.random();return a+(a<0.5?b:-b)},_cssSelectorAncestor:function(a,
