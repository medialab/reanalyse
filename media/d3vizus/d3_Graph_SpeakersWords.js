var dd=null;
////////////////////////////////////////////////////
function buildD3_Graph_SpeakersWords(data,theId) {
	dd=data;
	var w = 650,
		h = 450,
		legendW = 100,
	...
	var minEdgeWeight = d3.min(data.edges, function(d) { return d.weight;});
	var maxEdgeWeight = d3.max(data.edges, function(d) { return d.weight;});
...
*/
	...
	var edge = vis.selectAll("line.edge")
		...
		.enter().append("svg:line")
			.attr("title", function(d) { return "tfidf="+d.weight; })
	...
	var node = vis.selectAll("circle.node")
		...
		.enter().append("svg:circle")
			.attr("title", function(d) { return d.category=='Speaker' ? d.label+"\n"+d.otherwords : ""; })
	...
	var edgelabels = vis.selectAll("edge.labels")
		.data(data.edges)
	...
	var nodelabels = vis.selectAll("node.labels")
		.data(data.nodes)
		.enter().append("svg:text")
			//.attr("class","textlabs")
			//.style("opacity", 0.1)
			...
			.attr("fill", function(d) { return d.category=='Speaker' ? "red" : "black";})
