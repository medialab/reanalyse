...
// WARNING: som changes were made by pierre@medialab, testing...
// you may search for "patch"..
...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        var defaults = {
            ...
            // medialab patch to add properties !
			sFilterRow: "tfoot tr",
			sFilterHead: ""
        };
        ...
        return this.each(function () {
            ...
            var sFilterRow = properties.sFilterRow ; 
...
//            }
			// medialab patched here
			var tr = $(sFilterRow);
			
            $(properties.sFilterHead + " th", oTable).each(function (index) {
                i = index;
